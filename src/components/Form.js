    ...
    <div>
      ...
      {props.article  ?(
        ...
        <div className='mb-3'>
            ...
            <input type= 'text' className='form-control' id="title" placeholder="Please update title"
                value={title} onChange= {e => setTitle(e.target.value)} />

            <label htmlFor = 'description' className=''form-label> Description </label>
            <textarea className='form-control' id="description" rows='5' placeholder="Please update description"            value={description} onChange= {e => setDescription(e.target.value)}></textarea>
